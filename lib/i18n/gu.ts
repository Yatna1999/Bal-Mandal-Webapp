export const gu = {
  ...
  audit: {
    title: 'ઓડિટ લોગ',
    allTables: 'બધા કોષ્ટક',
    allActors: 'બધા કાર્યકર',
    changedField: 'બદલ્યું',
    filterByTable: 'કોષ્ટક પસંદ કરો',
    filterByActor: 'કાર્યકર પસંદ કરો',
    noLogs: 'કોઈ ઓડિટ રેકોર્ડ મળ્યો નથી',
  },
  auditFields: {
    full_name_gu: 'નામ',
    full_name_en: 'અંગ્રેજી નામ',
    attendance_status: 'હાજરી',
    presabha_status: 'સંપર્ક',
    dob: 'જન્મતારીખ',
    standard: 'ધોરણ',
    school_name_gu: 'શાળા',
    sabha_type: 'સભાનો પ્રકાર',
    status: 'સ્થિતિ',
    mobile: 'મોબાઇલ',
    mother_mobile: 'માતાનો મોબાઇલ',
    father_mobile: 'પિતાનો મોબાઇલ',
    notes_gu: 'નોંધ',
    title_gu: 'નિયમ',
    start_date: 'શરૂઆત તારીખ',
    duration_months: 'સમયગાળો',
    role: 'હોદ્દો',
    is_active: 'સક્રિય',
    session_date: 'સભા તારીખ',
  ...
  exportCols: {
    ...
    status: 'સ્થિતિ',
    totalPresent: 'કુલ હાજર',
    totalSessions: 'કુલ સભા',
    percentage: 'ટકાવારી (%)',
    totalPresentFooter: 'કુલ હાજર',
    attendanceRateFooter: 'હાજરી ટકાવારી',
    contactPersonFooter: 'સંપર્ક કરનાર',
    ahnikTotal: 'કુલ (૭ માંથી)',
    recorder: 'નોંધનાર',
    niyamTitle: 'નિયમનું નામ',
    startDate: 'શરૂઆત તારીખ',
    duration: 'સમયગાળો',
    endDate: 'પૂરી તારીખ',
    notes: 'નોંધ',
    karyakarName: 'કાર્યકરનું નામ',
    role: 'હૌદ્દો / ભૂમિકા',
    sabhas: 'સંભાળતી સભાઓ',
    totalTasks: 'કુલ કામ',
    onTime: 'સમયસર પૂરાં',
